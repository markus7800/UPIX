...
def get_arg_parser():
    ...
    parser.add_argument("vectorisation", default="vmap", help="vmap_local | vmap_global | pmap | smap_global | smap_local")
    ...
    parser.add_argument("-maxpow", default=0, type=int, required=False, help="only used for in viz_* scripts")
