...
def get_arg_parser():
    ...
    parser.add_argument("vectorisation", default="vmap", help="vmap_local | vmap_global | vmap_batched_global | pmap | smap_glibal | smap_local")
    ...
    parser.add_argument("-batch_size", default=0, type=int, required=False)
