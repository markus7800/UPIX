...
ax1.set_yscale("log")
ax1.plot(list(range(1,len(time)+1)), time, marker=M[0], label="AMD EPYC 9355 256GB", zorder=3, alpha=0.5, color="tab:red")
# ax1.plot(range(1,len(a40_time)+1), marker=M[2], label="A40 48GB", zorder=3, alpha=0.5)
ax1.plot(list(range(1,len(a100_time)+1)), a100_time, marker=M[3], label="A100 80GB", zorder=3, alpha=0.5, color="tab:orange")
ax1.plot(list(range(1,len(l40s_time)+1)), l40s_time, marker=M[1], label="L40s 48GB", zorder=3, alpha=0.5, color="tab:blue")
leg = ax1.legend()
...
ax2.set_yscale("log")
ax2.plot(list(range(1,len(factors_size)+1)), factors_size, marker=M[2], label="cumulative size of factors", color="tab:gray", zorder=1, alpha=0.5)
