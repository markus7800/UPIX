...
from upix.types import Trace, PRNGKey, FloatArrayLike, FloatArray, ArrayLike, BoolArray, IntArray
from upix.distributions.constraints import ConstraintT, real
...
def param(address: str, init_value: FloatArrayLike, constraint: ConstraintT = real) -> FloatArrayLike:
    global SAMPLE_CONTEXT_STORE
    ctx = SAMPLE_CONTEXT_STORE.get()
    if ctx is not None:
