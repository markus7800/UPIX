...
from upix.types import PRNGKey, Trace, Traces, StackedTrace, StackedTraces
import jax
import jax.numpy as jnp
from upix.parallelisation import ParallelisationConfig, VectorisationType, vectorise, parallel_run, SHARDING_AXIS
from upix.jax_utils import smap_vmap, batched_vmap
...
def estimate_log_Z_for_SLP_from_prior(slp: SLP, N: int, rng_key: PRNGKey, pconfig: ParallelisationConfig):
    ...
    log_weights, in_support = parallel_run(vectorised_fn, (rng_keys,), N, pconfig.vectorisation, pconfig.num_workers)
